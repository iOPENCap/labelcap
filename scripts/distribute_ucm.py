...
for raw_caption in raw_captions:
    ...
    # check filepath
    assert os.path.exists(f'../public/data/server/datasets/images/ucm/{raw_caption["filename"]}')
    caption['filepath'] = [f'/data/server/datasets/images/ucm/{raw_caption["filename"]}']
